...
def test_block_cmd(treasurenet_cluster):
    """
    - start 2 treasurenet nodes
    - wait for a certain height
    - stop the node1
    - use the 'block' cli cmd
    - restart treasurenet node1
    """

    # wait for specific height
    node1 = treasurenet_cluster.cosmos_cli(1)
    ...
    # start node1 again
    supervisorctl(
        treasurenet_cluster.base_dir / "../tasks.ini", "start", "treasurenet_5005-1-node1"
    )
