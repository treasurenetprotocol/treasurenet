...
def test_block(treasurenet_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on treasurenet and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(treasurenet_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(treasurenet_cluster, geth, True)


def get_blocks(treasurenet_rpc_ws, geth, with_transactions):
    w3: Web3 = treasurenet_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    treasurenet_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [treasurenet_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(eth_rpc, geth_rpc, "eth_accounts", [])


def test_syncing(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(treasurenet_cluster, geth):
    # on treasurenet the proof query will fail for block numbers <= 2
...
def test_get_code(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(treasurenet_cluster, geth):
    w3: Web3 = treasurenet_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(treasurenet_cluster, geth):
...
def test_incomplete_send_transaction(treasurenet_cluster, geth):
