def test_single_request_netversion(treasurenet_cluster):
    treasurenet_cluster.use_websocket()
    eth_ws = treasurenet_cluster.w3.provider
...
def test_batch_request_netversion(treasurenet):
    return


def test_ws_subscribe_log(treasurenet):
    return


def test_ws_subscribe_newheads(treasurenet):
    return
