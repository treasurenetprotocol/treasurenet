...
import (
	...
	"github.com/treasurenetprotocol/treasurenet/indexer"
	"github.com/treasurenetprotocol/treasurenet/rpc/backend/mocks"
...
func (suite *BackendTestSuite) SetupTest() {
	...
	clientCtx := client.Context{}.WithChainID("treasurenet_5005-1").
		WithHeight(1).
