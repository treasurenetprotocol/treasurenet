...
import (
	...
	evmenc "github.com/treasurenetprotocol/treasurenet/encoding"
)
...
const SimAppChainID = "treasurenet_5005-1"
const NewSimAppChainID = "treasurenet_8000-1"
...
func TestAppImportExport(t *testing.T) {
	...
	ctxB := newApp.NewContext(true, tmproto.Header{Height: app.LastBlockHeight(), ChainID: NewSimAppChainID})
