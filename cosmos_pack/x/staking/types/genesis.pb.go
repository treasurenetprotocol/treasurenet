...
type GenesisState struct {
	...
	// last_tat_total_power tracks the tat total amounts of bonded tokens recorded during
	// the previous end block.
	LastTatTotalPower github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,9,opt,name=last_tat_total_power,json=lastTatTotalPower,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"last_tat_total_power" yaml:"last_tat_total_power"`
}
...
type LastValidatorPower struct {
	...
	// tatpower defines the tatpower of the validator.
	TatPower int64 `protobuf:"varint,3,opt,name=tat_power,proto3" json:"tat_power,omitempty"`
}
