...
type Validator struct {
	...
	// tat的权重
	TatPower int64 `protobuf:"varint,4,opt,name=tatpower,proto3" json:"tatpower,omitempty"`
}
...
func (m *Validator) GetTatPower() int64 {
	if m != nil {
		return m.TatPower
	}
	return 0
...
func (m *ValidatorUpdate) GetTatPower() int64 {
	if m != nil {
		return m.TatPower
	}
	return 0
