...
func TestABCIValidatorFromPubKeyAndPower(t *testing.T) {
	...
	abciVal := TM2PB.NewValidatorUpdate(pubkey, 10, 10)
	assert.Equal(t, int64(10), abciVal.Power)

	assert.Panics(t, func() { TM2PB.NewValidatorUpdate(nil, 10, 10) })
	assert.Panics(t, func() { TM2PB.NewValidatorUpdate(pubKeyEddie{}, 10, 10) })
}
