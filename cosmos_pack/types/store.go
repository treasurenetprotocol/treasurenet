...
// Iterator over all the keys with a certain prefix in ascending order 按升序对具有特定前缀的所有键进行迭代器
func KVStorePrefixIterator(kvs KVStore, prefix []byte) Iterator {
	return types.KVStorePrefixIterator(kvs, prefix)
}

// Iterator over all the keys with a certain prefix in descending order. 按降序遍历具有特定前缀的所有键。
...
// Items iterated and skipped in ascending order. 项目按升序迭代和跳过
...
// Items iterated and skipped in descending order. 项目按降序迭代和跳过
