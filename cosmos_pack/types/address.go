...
// ValAddressFromHex creates a ValAddress from a hex string. 从十六进制字符串创建ValAddress
func ValAddressFromHex(address string) (addr ValAddress, err error) {
	bz, err := addressBytesFromHexString(address)
	return ValAddress(bz), err
}

// ValAddressFromBech32 creates a ValAddress from a Bech32 string. 从Bech32字符串创建ValAddress
