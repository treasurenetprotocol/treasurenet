...
// DecCoins defines a slice of coins with decimal values 定义了一片具有十进制值的硬币
...
// NewDecCoinsFromCoins constructs a new coin set with decimal values  构造了一个带有十进制值的新硬币集
// from regular Coins. 来自普通硬币
...
// Sub subtracts a set of DecCoins from another (adds the inverse). 从另一个中减去一组
