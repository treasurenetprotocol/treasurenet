...
import (
	...
	ante "github.com/treasurenetprotocol/treasurenet/app/ante"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.Setup(checkTx, func(app *app.TreasurenetApp, genesis simapp.GenesisState) simapp.GenesisState {
	...
	suite.ctx = suite.app.BaseApp.NewContext(checkTx, tmproto.Header{Height: 2, ChainID: "treasurenet_5005-1", Time: time.Now().UTC()})
