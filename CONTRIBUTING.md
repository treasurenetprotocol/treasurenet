...
Now `origin` refers to my fork and `upstream` refers to the Treasurenet version.
So I can `git push -u origin main` to update my fork, and make pull requests to Treasurenet from there.
