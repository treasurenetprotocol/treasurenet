...
import (
	...
	"github.com/treasurenetprotocol/treasurenet/x/incentives/keeper"
	"github.com/treasurenetprotocol/treasurenet/x/incentives/types"
)
...
func (am AppModule) NewEndBlock(_ sdk.Context, _ abci.RequestEndBlock, _ sdk.ABCIMessageLogs) []abci.ValidatorUpdate {
	return []abci.ValidatorUpdate{}
}
