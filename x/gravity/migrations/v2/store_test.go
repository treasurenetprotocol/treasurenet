...
import (
	...
	v1 "github.com/treasurenetprotocol/treasurenet/x/gravity/migrations/v1"
	v2 "github.com/treasurenetprotocol/treasurenet/x/gravity/migrations/v2"
	"github.com/treasurenetprotocol/treasurenet/x/gravity/types"
)

const denom string = "unit"
...
func TestMigrateEthAddressByValidator(t *testing.T) {
	...
	validator, err := sdk.ValAddressFromBech32("treasurenetvaloper102e577f29shw9ngdp462ml3nj44mdrg4k6e9wk")
	assert.NoError(t, err)
...
func TestMigrateValidatorByEthAddressKey(t *testing.T) {
	...
	validator, err := sdk.ValAddressFromBech32("treasurenetvaloper1n0paayv2g40q7hl8g9g4l2v0r763xpszwd3p38")
	assert.NoError(t, err)
...
func TestMigrateBatchConfirms(t *testing.T) {
	...
	orch, err := sdk.AccAddressFromBech32("treasurenet102e577f29shw9ngdp462ml3nj44mdrg4hy2y07")
	assert.NoError(t, err)
	ethAddr := "0x2a24af0501a534fca004ee1bd667b783f205a546"
...
func TestMigrateOutgoingTxs(t *testing.T) {
	...
	outtx := &types.OutgoingTransferTx{
		...
		Sender:      "treasurenet102e577f29shw9ngdp462ml3nj44mdrg4hy2y07",
...
func TestMigrateStoreKeysFromKeys(t *testing.T) {
	...
	accAddr, _ := sdk.AccAddressFromBech32("treasurenet102e577f29shw9ngdp462ml3nj44mdrg4hy2y07")
	valAddr, _ := sdk.ValAddressFromBech32("treasurenetvaloper102e577f29shw9ngdp462ml3nj44mdrg4k6e9wk")
	ethAddrStr := "0x7Ab34f792A2C2eE2cD0D0d74aDFe33956Bb68d15"
...
// 	accAddr, _ := sdk.AccAddressFromBech32("treasurenet1ahx7f8wyertuus9r20284ej0asrs085ceqtfnm")
