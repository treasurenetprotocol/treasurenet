...
import (
	...
	"github.com/treasurenetprotocol/treasurenet/x/epochs/client/cli"
	"github.com/treasurenetprotocol/treasurenet/x/epochs/keeper"
	"github.com/treasurenetprotocol/treasurenet/x/epochs/types"
)
...
func (am AppModule) NewEndBlock(ctx sdk.Context, _ abci.RequestEndBlock, _ sdk.ABCIMessageLogs) []abci.ValidatorUpdate {
	return []abci.ValidatorUpdate{}
}
