...
import (
	...
	"github.com/treasurenetprotocol/treasurenet/x/inflation/client/cli"
	"github.com/treasurenetprotocol/treasurenet/x/inflation/keeper"
	"github.com/treasurenetprotocol/treasurenet/x/inflation/types"
)
...
func (am AppModule) NewEndBlock(c_ sdk.Context, r_ abci.RequestEndBlock, _ sdk.ABCIMessageLogs) []abci.ValidatorUpdate {
	return []abci.ValidatorUpdate{}
}
